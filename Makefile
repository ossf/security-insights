...
gendocs: genopenapi
	...
	@mkdir -p docs
	@cd cmd/openapi2md && go run . -input ../../openapi.yaml -output ../../docs
	@echo "  >  Adding Jekyll front matter to schema.md ..."
	@{ \
		echo "---"; \
		echo "layout: default"; \
		...
		echo ""; \
		cat docs/schema.md; \
	} > docs/schema.md.tmp && mv docs/schema.md.tmp docs/schema.md
